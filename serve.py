...
DIESER SERVER RUFT NICHTS AB. Er liefert Dateien aus, sonst nichts. Kein
Netzverkehr nach draussen, keine Schlüssel, keine Hintergrundschleifen,
nichts, was ausfallen oder Geld kosten könnte.
...
def main():
    ...
    print("Nur Dateiauslieferung — keine Abrufe nach draussen.")
    srv.serve_forever()
