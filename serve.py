...
**Er ruft nichts ab.** Statische Dateien, sonst nichts: kein Konto, kein
Schlüssel, keine Hintergrundschleife.

Gebraucht wird er überhaupt nur, um die Seite unter einer festen Adresse
und hinter einem Passwort bereitzustellen. Wer sie lokal benutzen will,
öffnet `static/index.html` per Doppelklick — dafür ist das Ganze gebaut.
